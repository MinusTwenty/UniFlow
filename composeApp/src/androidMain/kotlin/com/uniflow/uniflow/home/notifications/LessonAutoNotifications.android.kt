...
actual object LessonNotificationScheduler {
    ...
    actual fun scheduleAll(schedules: List<LessonNotificationSchedule>) {
        ...
        schedules.forEach { schedule ->
            ...
            scheduleAlarm(alarmManager, schedule.triggerAt, pendingIntent)
        }
    }
...
private fun ensureLessonNotificationChannel(context: Context) {
    ReminderNotificationScheduler.ensureNotificationChannel(context)
}
